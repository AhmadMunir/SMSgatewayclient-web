    ...
    <div id="wrapper">
      ...
      <?php $this->load->view('home/_partials/navbar') ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Paket Data Telkomsel</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
function startApp() {
  ...
  // mengambil value no tujuan
    ...
    //isi pesan
    var message = 'Pengisian Paket Data Telkomsel Senilai '+document.getElementById("message").value+' berhasil! Jangan pernah bosan ya beli di SIPULsa company';
        ...
        if (response.success) {
          log.textContent = log.textContent + "\n" +
           ...
           $.ajax({
              ...
              type: "post",
              data: {nama_produk:'Telkomsel', ke:ke, besar:besaran,jenis:'Paket Data'},
          ...
          $.ajax({
             ...
             type: "post",
             data: {nama_produk:'Telkomsel', ke:ke, besar:besaran, ket:ket,jenis:'Paket Data'},
             success: function(data){
