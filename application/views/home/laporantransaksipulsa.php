    ...
    <div id="wrapper">
      ...
      <?php $this->load->view('home/_partials/navbar') ?>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
          <div class="row">
            <table id="pulsa" class="table table-striped table-bordered" style="width:100%">
              <thead>
                <tr>
                  <td>No</td>
                  <td>Pembelian</td>
              ...
              <tbody>
                ...
                foreach ($pulsa as $k) {
                  $stts = $k->status;
                  ?>
                  <tr class="<?php if ($stts == 'Gagal') {
                    echo "danger";
                  }else {
                    echo "success";
                  } ?>">
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $k->jenis_produk." ";echo $k->nama_produk." ";echo $k->Nominal; ?></td>
