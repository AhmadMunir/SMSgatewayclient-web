    ...
    <div id="wrapper">
      ...
      <?php $this->load->view('home/_partials/navbar') ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pulsa Axis</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
function startApp() {
  ...
  // mengambil value no tujuan
    ...
    //isi pesan
    var message = 'Pengisian Pulsa Axis Senilai '+document.getElementById("message").value+' berhasil! Jangan pernah bosan ya beli di SIPULsa company';
        ...
        if (response.success) {
          log.textContent = log.textContent + "\n" +
           ...
           $.ajax({
              url:  "<?php echo base_url('index.php/Home/pulsa/simpansukses'); ?>",
              type: "post",
              data: {nama_produk:'Axis', ke:ke, besar:besaran,jenis:'Pulsa'},
              success: function(data){
                alert("Selamat Pembelian Sukses!");
              }
           });
          ...
          $.ajax({
             url:  "<?php echo base_url('index.php/Home/pulsa/simpangagal'); ?>",
             type: "post",
             data: {nama_produk:'Axis', ke:ke, besar:besaran, ket:ket,jenis:'Pulsa'},
             success: function(data){
