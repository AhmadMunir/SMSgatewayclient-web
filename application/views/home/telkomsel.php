    ...
    <div id="wrapper">
      ...
      <?php $this->load->view('home/_partials/navbar') ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pulsa Pulsa</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
              ...
              <input type="text" id="to" placeholder="Masukkan Nomor Yang akan diisi pulsa"/> <br/><br>
              <label for="nominal">Nominal Pengisian</label> <br>
              <select name="message" id="message" style="width: 200px;">
                <option value="">Pilih</option>
                <?php
                foreach ($pulsa as $data) { // Lakukan looping pada variabel siswa dari controller
...
function startApp() {
  ...
  // mengambil value no tujuan
    ...
    //isi pesan
    var message = 'Pengisian Pulsa Telkomsel Senilai '+document.getElementById("message").value+' berhasil! Jangan pernah bosan ya beli di SIPULsa company';
        ...
        if (response.success) {
          log.textContent = log.textContent + "\n" +
           ...
           $.ajax({
              ...
              type: "post",
              data: {nama_produk:'Telkomsel', ke:ke, besar:besaran,jenis:'Pulsa'},
          ...
          $.ajax({
             ...
             type: "post",
             data: {nama_produk:'Telkomsel', ke:ke, besar:besaran, ket:ket,jenis:'Pulsa'},
             success: function(data){
