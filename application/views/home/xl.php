...
function startApp() {
  ...
  // mengambil value no tujuan
    ...
    //isi pesan
    var message = 'Pengisian Pulsa Xl Senilai '+document.getElementById("message").value+' berhasil! Jangan pernah bosan ya beli di SIPULsa company';
        ...
        if (response.success) {
          log.textContent = log.textContent + "\n" +
           ...
           $.ajax({
              ...
              type: "post",
              data: {nama_produk:'Xl', ke:ke, besar:besaran,jenis:'Pulsa'},
          ...
          $.ajax({
             ...
             type: "post",
             data: {nama_produk:'Xl', ke:ke, besar:besaran, ket:ket,jenis:'Pulsa'},
             success: function(data){
